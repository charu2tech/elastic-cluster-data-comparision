...
public class IndexSettingsValidater implements ElasticApiValidater{
	private static final Logger LOGGER = LoggerFactory.getLogger(IndexSettingsValidater.class);
