...
public class IndexMappingsValidater implements ElasticApiValidater{
	private static final Logger LOGGER = LoggerFactory.getLogger(IndexMappingsValidater.class);
